<template>
  <div>
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
      <div>
        <h2 class="text-3xl font-black text-warmgray-800 dark:text-warmgray-50 theme-transition">
          Wöchentliche Liste
        </h2>
        <p class="text-warmgray-600 dark:text-warmgray-400 theme-transition mt-1 font-medium">
    ...
    <div v-if="isAddingItem" class="card mb-8 theme-transition">
      <h3 class="text-xl font-black mb-5 text-warmgray-800 dark:text-white theme-transition">Neuer Artikel</h3>
    ...
    <div v-if="totalItemsCount === 0" class="card text-center py-12 theme-transition">
      ...
      <h3 class="text-xl font-black text-warmgray-700 dark:text-warmgray-200 mb-2 theme-transition">Ihre Einkaufsliste ist leer</h3>
      <p class="text-warmgray-500 dark:text-warmgray-400 max-w-sm mx-auto theme-transition font-medium">
