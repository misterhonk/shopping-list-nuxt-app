    ...
    <div class="relative" ref="menuRef">
      ...
      >
        <svg
          ...
          class="h-6 w-6 text-gray-700 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-500"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        >
          <div class="py-1" role="none">
            ...
            <NuxtLink
              ...
              @click="closeMenu"
            >
              <span class="flex-1 text-left">Statistik</span>
              <svg
                class="ml-2 h-5 w-5"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <NuxtLink
              ...
              @click="closeMenu"
            >
              <span class="flex-1 text-left">Einstellungen</span>
              <svg
                class="ml-2 h-5 w-5"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <NuxtLink
              ...
              @click="closeMenu"
            >
              <span class="flex-1 text-left">Über die App</span>
              <svg
                class="ml-2 h-5 w-5"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
