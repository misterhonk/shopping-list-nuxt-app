  ...
  <div class="fixed bottom-14 right-4 bg-orange-500 text-white p-4 rounded-lg shadow-lg z-50">
    <div class="text-xs">
      <div class="flex justify-between items-center mb-1">
        ...
        <button @click="isExpanded = !isExpanded" class="text-white ml-2">
          <svg v-if="isExpanded" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
