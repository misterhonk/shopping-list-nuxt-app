    ...
    <div class="grid grid-cols-2 sm:flex flex-wrap gap-2">
      ...
      >
        <div class="flex items-center">
          ...
          <span class="truncate mx-1">{{ list.name }}</span>
          <span class="ml-1 text-xs bg-white bg-opacity-30 rounded-full px-1 sm:px-2 py-0.5 flex-shrink-0">{{ getItemsCount(list) }}</span>
          <button
            v-if="lists.length > 1"
