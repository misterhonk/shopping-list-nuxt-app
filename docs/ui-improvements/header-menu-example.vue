  ...
  <div ref="menuRef" class="header-menu">
    ...
    <div v-if="isMenuOpen" class="dropdown-menu">
      <div class="menu-item" @click="toggleDarkMode">
        ...
        <svg v-if="themeStore.isDarkMode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
          <path fill="none" d="M0 0h24v24H0z"/>
      ...
      <div class="menu-item" @click="navigateToStatistics">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
          <path fill="none" d="M0 0h24v24H0z"/>
          <path d="M9 17H7V10H9V17ZM13 17H11V7H13V17ZM17 17H15V13H17V17ZM19 19H5V5H19V19.1ZM19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3Z"/>
        </svg>
      </div>
