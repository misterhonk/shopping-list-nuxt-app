...
export class ItemService extends BaseService {
   ...
   */
  private readonly listService: ShoppingListService;
    ...
    return (
      this.safeOperation(() => {
        ...
        return items.map(item => ({
          ...item,
          listId, // Stelle sicher, dass jedes Item die listId hat
        }));
  ...
  public addItem(listId: string, item: Partial<ShoppingItem>): ShoppingItem | null {
    return this.safeOperation(() => {
      ...
      const newItem: ShoppingItem = {
        ...
        listId, // Wichtig: Setze die ListId für das neue Item
      };
  ...
  public updateItem(
    ...
    return this.safeOperation(() => {
      ...
      const updatedItem: ShoppingItem = {
        ...
        listId, // Stelle sicher, dass die ListId gesetzt ist
        modifiedAt: Date.now(),
      };
